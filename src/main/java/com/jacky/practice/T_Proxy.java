...
public class T_Proxy {
    ...
    @Test
    public void test() throws IOException, CannotCompileException, NotFoundException, IllegalAccessException, InstantiationException {
		/*
		...
		volatile
		synchronized  ObjectMonitor wait(),notify()

		jdk proxy   ProxyGenerator

		ASM-cglib
		instrumentation-agent  transForm
		ASM-javassit

		*/

        ClassPool cp = ClassPool.getDefault();
        CtClass cc = cp.get("com.jacky.practice.Base");
        CtMethod m = cc.getDeclaredMethod("process");
        m.insertBefore("{ System.out.println(\"start\"); }");
        m.insertAfter("{ System.out.println(\"end\"); }");
        Class c = cc.toClass();
        cc.writeFile("/Users/huangchao/IdeaProjects/practice/target/classes/com/jacky/practice/Basexxx");
